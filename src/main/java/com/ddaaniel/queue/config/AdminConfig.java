...
public class AdminConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
     ...
     * jdbcTemplate.
     * update("INSERT INTO especialista (id, nome, tipo_especialista) VALUES (1, 'Dr. João da Silva', 'ODONTOLOGO');"
     * );
     * }
     *
     * if (!especialistaExiste(2)) {
     * jdbcTemplate.
     * update("INSERT INTO especialista (id, nome, tipo_especialista) VALUES (2, 'Dra. Maria Oliveira', 'ORTOPEDISTA');"
     * );
     * }
     *
     * if (!especialistaExiste(3)) {
     * jdbcTemplate.
     * update("INSERT INTO especialista (id, nome, tipo_especialista) VALUES (3, 'Dr. Pedro Santos', 'CARDIOLOGISTA');"
     * );
     * }
     *
     ...
     * jdbcTemplate.
     * update("INSERT INTO disponibilidade (especialista_id, data) VALUES (1, '2023-12-01');"
     * );
     * }
     * if (!disponibilidadeExiste(1, "2023-12-15")) {
     * jdbcTemplate.
     * update("INSERT INTO disponibilidade (especialista_id, data) VALUES (1, '2023-12-15');"
     * );
     * }
     * if (!disponibilidadeExiste(2, "2023-12-10")) {
     * jdbcTemplate.
     * update("INSERT INTO disponibilidade (especialista_id, data) VALUES (2, '2023-12-10');"
     * );
     * }
     * if (!disponibilidadeExiste(2, "2023-12-20")) {
     * jdbcTemplate.
     * update("INSERT INTO disponibilidade (especialista_id, data) VALUES (2, '2023-12-20');"
     * );
     * }
     * if (!disponibilidadeExiste(3, "2023-12-05")) {
     * jdbcTemplate.
     * update("INSERT INTO disponibilidade (especialista_id, data) VALUES (3, '2023-12-05');"
     * );
     * }
     * if (!disponibilidadeExiste(3, "2023-12-25")) {
     * jdbcTemplate.
     * update("INSERT INTO disponibilidade (especialista_id, data) VALUES (3, '2023-12-25');"
     * );
     * }
     *
     *
    ...
    /*
     * jdbcTemplate.
     * update("INSERT INTO especialista (id, nome, tipo_especialista)\n" +
     * "VALUES \n" +
   ...
   * String sql =
   * "SELECT COUNT(*) FROM disponibilidade WHERE especialista_id = ? AND data = ?"
   * ;
